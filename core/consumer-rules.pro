...
-keep class com.dicoding.core.data.source.MovieRepository { *; }
-keep class com.dicoding.core.** { *; }

# Keep Resource classes and their members
-keep class com.dicoding.core.data.source.Resource$Error { *; }
-keep class com.dicoding.core.data.source.Resource$Loading { *; }
-keep class com.dicoding.core.data.source.Resource$Success { *; }
-keep class com.dicoding.core.data.source.Resource { *; }

# Keep source classes and their members
-keep class com.dicoding.core.data.source.local.LocalDataSource { *; }
-keep class com.dicoding.core.data.source.remote.RemoteDataSource { *; }
-keep class com.dicoding.core.data.source.remote.retrofit.ApiServices { *; }
-keep class com.dicoding.core.data.source.local.room.MovieDao { *; }
...
-keep class  com.dicoding.core.domain.repository.IMovieRepository { *; }
-keep class  com.dicoding.core.domain.usecase.MovieInteractor { *; }
-keep class  com.dicoding.core.domain.usecase.MovieUseCase { *; }

# Keep UI classes and their members
-keep class com.dicoding.core.presentation.MovieAdapter { *; }
-keep class com.dicoding.core.presentation.MovieAdapter$OnItemClickCallback { *;}

# Keep utility classes
-keep class com.dicoding.core.utils.AppExecutors { *; }
-keep class com.dicoding.core.utils.DarkMode { *; }
